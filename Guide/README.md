...
| [Test Branch](test_branch.md) | How `test` works — competition state machine, dashboard, all 9 challenges |
...
| View live dashboard | `test` | Open `http://<robot_ip>:8080` in browser |
