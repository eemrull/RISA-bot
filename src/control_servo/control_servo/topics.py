...
ODOM_TOPIC = '/odom'
ODOM_PATH_LENGTH_TOPIC = '/odom/path_length'  # Float64, signed cumulative metres travelled
ODOM_DEBUG_TOPIC = '/odom/debug'              # JSON: raw/cumulative ticks, for tpm calibration
JOY_TOPIC = '/joy'
